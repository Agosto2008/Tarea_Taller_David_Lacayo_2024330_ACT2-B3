...
let subtotal1 = calcularSubtotal(compra1);
let iva1 = calcularIVA(subtotal1, tasaIva);
let total1 = calcularTotal(subtotal1, iva1);
...
let subtotal2 = calcularSubtotal(compra2);
let iva2 = calcularIVA(subtotal2, tasaIva);
let total2 = calcularTotal(subtotal2, iva2);
...
let compra3: number[] = [];
let subtotal3 = calcularSubtotal(compra3);
let iva3 = calcularIVA(subtotal3, tasaIva);
let total3 = calcularTotal(subtotal3, iva3);
